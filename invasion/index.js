...
function mechant(){		//objet des soupes
	...
	this.elem=document.createElement('img');
	this.elem.src='res/invader.png';
	this.elem.style.position='absolute';
	document.getElementById('dvg_jeux').appendChild(this.elem);
	
	this.aud=k_jeux_a.creason('res/son/explosion');
...
mechant.prototype.init_envahisseur=function(){		//positionnement des soupes dans la page au demarrage du jeux et en cour de jeux.
	...
	el.src='res/bonus.png';
	k_jeux_a.bonus='non';
	}
	else{
	el.src='res/invader.png';
	}
...
function objet_tir(){		//objet des rayons laser
	...
	this.elem=document.createElement('img');
	this.elem.src='res/lazer.png';
	this.elem.style.display='none';
	this.elem.style.position='absolute';
	document.getElementById('dvg_jeux').appendChild(this.elem);

	this.aud=k_jeux_a.creason('res/son/laser_04');
...
function accident(i){		//gestion de la colision entre les aliens et le vaisseau du hero
	...
	k_jeux_a.hero.elem.src='res/ship_touche.png';
	k_jeux_a.hero_toucher=setTimeout(function(){k_jeux_a.hero.elem.src='res/ship.png'},500);
	k_jeux_a.tb_mechant[i].elem.src='res/boum.png';
...
function menu_fin(){
	...
	var txt=document.createTextNode("C'est pas mal !");
	el.appendChild(txt);
    var s_ligne=document.createElement('br');
	el.appendChild(s_ligne);
     var s_ligne=document.createElement('br');
	el.appendChild(s_ligne);
    var txt=document.createTextNode(' cliquez pour recomencer !!');
	el.appendChild(txt);
	var s_ligne=document.createElement('br');
	el.appendChild(s_ligne);
	...
	var s_ligne=document.createElement('br');
	el.appendChild(s_ligne);
	var txt3=document.createTextNode('ton meilleur score: '+ k_jeux_a.score);
	el.appendChild(txt3);
	}
...
function init(){		//creation des instance pour le jeux et gestion des options
	...
	k_jeux_a.son_vie_gagne=k_jeux_a.creason('res/son/bonus');
	k_jeux_a.son_bonus=k_jeux_a.creason('res/son/bonus_b');
